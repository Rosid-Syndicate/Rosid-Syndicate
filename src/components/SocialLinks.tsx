import { SITE_NAME, SOCIAL_PROFILES, type SocialPlatform } from '../config/site'

/**
 * Official brand glyphs (monochrome, `currentColor`) so they inherit the
 * surrounding text colour and follow the design system rather than each
 * network's palette. Paths are the public-domain Simple Icons outlines of the
 * current logos (Facebook "f", Instagram camera, X, YouTube play, LinkedIn "in").
 */
const GLYPHS: Record<SocialPlatform, { label: string; path: string }> = {
  facebook: {
    label: 'Facebook',
